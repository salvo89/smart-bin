// Poirino Zona CONCENTRICOC (CCS): VIA ARPINO JACOPO, VIA BURZIO FRANCESCO, VIA CARMAGNOLA, VIA DE GASPERI ALCIDE, VIA DEGLI ALTENI, VIA FERRARIS GALILEO, CASCINA FONTE ANTICO, VIA FONTE ANTICO, VIA GORIZIA, VIA MAROCCO, VIA MARTIRI DELLA LIBERTÁ, VIA PANIZZA PAOLO, VIA S. GIOVANNI BOSCO, VIA S. GRATO, STRADA SAVONA, VIA THAON DI REVEL, VIA TRENTO, VIA VERDI GIUSEPPE, VIA XX SETTEMBRE, Via Carmagnola - Poirino
