// Chieri Zona 6B (CCS): VIA ALBUGNANO, VIA BERGOGNINO ROLANDO, STRADA CAMBIANO, VIALE CAPPUCCINI, VIA CINZANO, VIA CRIVELLO LUIGI, STRADA DEI TIGLI, STRADA DEL CHIAVENTONE, STRADA DEL PODIO, STRADA DEL VERDE, STRADA DEL VIBERNONE, STRADA DELLA LUIGINA, STRADA DELLA MOGLIA, STRADA DELLA MOLINA, STRADA DELLA RANA, BORGATA MADONNA, STRADA MADONNA, VIA MONTOSOLO, VIA MORIONDO, STRADA PASSATEMPO, STRADA PECETTO, STRADA RIO VAIORS, VIA ROLLANDINO MAESTRO, STRADA VALLERO, STRADA TETTI MARSINO, STRADA TETTI ROCCO
