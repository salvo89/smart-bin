// Pino Torinese Zona 2B (CCS): VIA ANTONELLI, VIA AUBERT, VIA BRICCOLA, VIA CAMANDONA, VIA CASA VERDE, VIA DEI BUCANEVE, VIA DEI COLLI, VIA DEI NARCISI, VIA DEL SOLE, VIA DELL'OLMO, VIA DELLE DALIE, VIA DELLE GENZIANE, VIA DELLE MARGHERITE, VIA DELLE ORCHIDEE, VIA DELLE ORTENSIE, VIA DELLE ROSE, VIA DELLE VIOLE, VIA GROSSO ALBERTO, VIA MARIA CRISTINA, VIA MONGRENO, VIA MONT CERVET, VIA MONTOLINO, VIA MONTOSOLO, PIAZZA MUNICIPIO, VIA NIELLI ANGELO, VIA PERGOLESI, VIA RICOTTI, VIA ROCCABIANCA, VIA S. MICHELE, VIA SASSI, VIA TETTI BROGLIA, VIA VALLE CEPPI, VIA VALLE GOLA, VIA VALLE MIGLIORETTI, VIA VIBÓ
