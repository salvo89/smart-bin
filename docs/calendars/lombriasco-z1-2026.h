// Lombriasco Zona unica (Covar14): BORGATA CAMPAGNINO, CASCINA BARRA DI FERRO, CASCINA OLTRE PO, CASCINA SPINA, PIAZZA RIMEMBRANZA, STRADA ANTICA DEL PORTO, STRADA ANTICA DI CASALGRASSO, STRADA DELLA VALLE, VIA AUTINETTI, VIA BELVEDERE, VIA BERNARDONA, VIA BOCCHIARDI, VIA CAMPOSANTO, VIA CARMAGNOLA, VIA CASTEL RAINERO, VIA CESARE PONTE, VIA DELLE ROSE, VIA DON AGAGLIATE, VIA DON CAPELLARI, VIA FIORITA, VIA GRIFFA, VIA LOMBRIASCHETTO, VIA ORTENSIA, VIA OSASIO (N. 9 e 13), VIA PAGLIETTA, VIA PONTE CESARE, VIA PRUSSERO, VIA SAN GIOVANNI BOSCO, VIA SAN SEBASTIANO, VIA TORINO, VIALE MAIRA, VIALE MONVISO, VIALE PO, VIALE SANTA CROCE, VICOLO BOSCHETTO, VICOLO BRAIDA, VICOLO CAMPAGNA, VICOLO CONGREGAZIONE, VICOLO CURVO, VICOLO MULINO, VICOLO ORTENSIA, VICOLO PAGLIETTA
