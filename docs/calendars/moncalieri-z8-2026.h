// Moncalieri Zona 8 (Covar14): BORGATA LA ROTTA, BORGATA TETTI SAPINI, CORSO SAVONA, PIAZZA GIUSEPPE FAILLA, STRADA PASUBIO, STRADA PRIVATA CHIUSO, STRADA PRIVATA NASI, STRADA SANDA, STRADA STATALE 393, STRADA TIRO A SEGNO, STRADA VILLASTELLONE, STRADA VIVERO, VIA ADA NEGRI, VIA ALCIDE DE GASPERI, VIA ARMANDO DIAZ, VIA BEATO BERNARDO, VIA BRUNO BUOZZI, VIA CAVOUR (NUMERI PARI E N. 1), VIA CESARE PAVESE, VIA DEL BALLO, VIA DON MINZONI, VIA FILIPPO TURATI, VIA GIUSEPPE GIACOSA, VIA GIUSEPPE UNGARETTI, VIA GRAZIA DELEDDA, VIA IV NOVEMBRE, VIA JOHN F. KENNEDY, VIA LUIGI EINAUDI, VIA MARIO PANNUNZIO, VIA MATILDE SERAO, VIA MOLINO DEL PASCOLO, VIA MONTE NERO, VIA MONVISO, VIA PIER CAPPONI, VIA PRIVATA ALTA ITALIA, VIA RENZO CATTANEO, VIA TENIVELLI, VIA VITTIME DI BOLOGNA, VIA XXIV MAGGIO, VIA DELL'INFANZIA, VIA DE NICOLA
