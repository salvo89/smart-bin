// Pino Torinese Zona 4B (CCS): VIA CHIERI - PECETTO, VIA DEI ROZ, VIA DEL TURCO, VIA LEONARDO DA VINCI, VIA MANZONI ALESSANDRO, VIA MONTEROTONDO, VIA PESCHIERI, VIA PODIO, VIA S. FELICE, VIA SOLAIRANO, VIA TETTI RAVOTTO, VIA TIZIANO
